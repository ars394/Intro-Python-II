...
player = Player('Patrick Star', room['outside'])
# Write a loop that:
#
...
def command(x):
    ...
    if (x == 'n') & (player.current_room.n_to != None):
        ...
        print(f'{player.name} will move north...')
    elif(x =='s') & (player.current_room.n_to != None):
        print(f'{player.name} will move south...')
        player.current_room  = player.current_room.s_to
    elif(x =='w') & (player.current_room.n_to != None):
        print(f'{player.name} will move west...')
        player.current_room = player.current_room.w_to
    elif(x =='e') & (player.current_room.n_to != None):
        print(f'{player.name} will move east...')
...
while run == True:
    ...
    x = input("Where would you like to go now? (n/e/w/s/q) : ")
    if (x == 'q'):
        run = False
    else:
        command(x)